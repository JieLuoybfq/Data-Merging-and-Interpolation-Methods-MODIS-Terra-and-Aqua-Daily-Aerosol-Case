...
for (station in stationList) {
	...
	for (i in 1:numberRow) {
		...
		value1 = extract(fileRaster,cbind(as.numeric(xLocation),as.numeric(yLocation)))

		fileRaster = raster(sprintf(path_MLE, format_aqsDate, format_aqsDate))
		value2 = extract(fileRaster,cbind(as.numeric(xLocation),as.numeric(yLocation)))

		fileRaster = raster(sprintf(path_WPC, format_aqsDate, format_aqsDate))
		value3 = extract(fileRaster,cbind(as.numeric(xLocation),as.numeric(yLocation)))

		fileRaster = raster(sprintf(path_SAA_uk, format_aqsDate, format_aqsDate))
		value4 = extract(fileRaster,cbind(as.numeric(xLocation),as.numeric(yLocation)))

		fileRaster = raster(sprintf(path_MLE_uk, format_aqsDate, format_aqsDate))
		value5 = extract(fileRaster,cbind(as.numeric(xLocation),as.numeric(yLocation)))

		fileRaster = raster(sprintf(path_WPC_uk, format_aqsDate, format_aqsDate))
		value6 = extract(fileRaster,cbind(as.numeric(xLocation),as.numeric(yLocation)))
		...
		value7 = extract(fileRaster,cbind(as.numeric(xLocation),as.numeric(yLocation)))
		...
		fileRaster = raster(filenames[1])
		value8 = extract(fileRaster,cbind(as.numeric(xLocation),as.numeric(yLocation)))
		...
		fileRaster = raster(filenames[1])
		value9 = extract(fileRaster,cbind(as.numeric(xLocation),as.numeric(yLocation)))
		...
		fileRaster = raster(filenames[1])
		value10 = extract(fileRaster,cbind(as.numeric(xLocation),as.numeric(yLocation)))

		fileRaster = raster(sprintf(path_uk_SAA, format_aqsDate, format_aqsDate))
		value11 = extract(fileRaster,cbind(as.numeric(xLocation),as.numeric(yLocation)))
		
		fileRaster = raster(sprintf(path_mi_SAA, format_aqsDate, format_aqsDate))
		value12 = extract(fileRaster,cbind(as.numeric(xLocation),as.numeric(yLocation)))

		fileRaster = raster(sprintf(path_miAs1, format_aqsDate, format_aqsDate))
		value13 = extract(fileRaster,cbind(as.numeric(xLocation),as.numeric(yLocation)))
	...
	# --------------------------------------------------------------------------------------------------------------------------------------------------
		...
		# temp_dataframe$value1 = value1
		# temp_dataframe$value2 = value2
		# temp_dataframe$value3 = value3
		# temp_dataframe$a_date = aqsTime
		# temp_dataframe$avg = record1[i, 2]
		result_dataframe = rbind(result_dataframe,temp_dataframe)
	}
	print(result_dataframe)
	# write.csv(result_dataframe, file="nghia_do.csv")
